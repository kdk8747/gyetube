  ...
  ionViewDidLoad() {
    ...
    this.event.subscribe('TabsGroup_ProceedingDetail', (obj) => {
      ...
      if (childNav.length() == 0) {
        ...
        setTimeout(() => this.navCtrl.getActiveChildNavs()[0].select(1), 60);
      }
    });
    ...
    this.event.subscribe('TabsGroup_DecisionDetail', (obj) => {
      ...
      if (childNav.length() == 0) {
        ...
        setTimeout(() => this.navCtrl.getActiveChildNavs()[0].select(2), 60);
      }
    });
    ...
    this.event.subscribe('TabsGroup_ActivityDetail', (obj) => {
      ...
      if (childNav.length() == 0) {
        ...
        setTimeout(() => this.navCtrl.getActiveChildNavs()[0].select(3), 60);
      }
    });
    ...
    this.event.subscribe('TabsGroup_ReceiptDetail', (obj) => {
      ...
      if (childNav.length() == 0) {
        ...
        setTimeout(() => this.navCtrl.getActiveChildNavs()[0].select(4), 60);
      }
    });
  }
