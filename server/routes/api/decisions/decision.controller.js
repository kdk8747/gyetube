...
var decisions2 = [
  { id: 1, prevId: 0, state: 0, description: 'dummy content', abstainers: ['1'], accepters: ['2', '3'], rejecters: ['4', '5'], createdDate: new Date(2016, 5, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 1, totalElapsedTime: 30, totalDifference: +4080000, childActivities: [1, 6, 10], childReceipts: [], title: '설문조사' },
  { id: 2, prevId: 0, state: 0, description: 'dummy content', abstainers: [], accepters: ['1', '2', '3'], rejecters: ['4', '5'], createdDate: new Date(2016, 6, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 2, totalElapsedTime: 20, totalDifference: +340000, childActivities: [2, 8], childReceipts: [], title: '홍보 - 현수막' },
  { id: 3, prevId: 0, state: 0, description: 'dummy content', abstainers: [], accepters: ['1', '2', '3', '4', '5'], rejecters: [], createdDate: new Date(2016, 7, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 3, totalElapsedTime: 10, totalDifference: -150000, childActivities: [3], childReceipts: [], title: '한달에 한번 회의' },
  { id: 4, prevId: 0, state: 0, description: 'dummy content', abstainers: ['1'], accepters: ['2', '3'], rejecters: ['4', '5'], createdDate: new Date(2016, 8, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 4, totalElapsedTime: 20, totalDifference: +352500, childActivities: [4, 5], childReceipts: [], title: '지역구 별 통계 조사' },
  { id: 5, prevId: 0, state: 0, description: 'dummy content', abstainers: ['1'], accepters: ['2', '3'], rejecters: ['4', '5'], createdDate: new Date(2016, 9, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 5, totalElapsedTime: 20, totalDifference: -40000, childActivities: [7, 9], childReceipts: [], title: '시민사회 연대' }
];
var decisionID2 = 6;
