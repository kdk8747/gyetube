...
var decisions = [
  { id: 1, prevId: 0, state: 0, content: 'dummy content', abstainers:['1'], accepters:['2','3'], rejecters:['4','5'], createdDate: new Date(2016, 5, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 1, totalElapsedTime: 30, totalDifference: +4080000, childActivities: [1, 6, 10], title: '소모임 활성화 방안 - 녹색평론 읽기모임' },
  { id: 2, prevId: 0, state: 0, content: 'dummy content', abstainers:['1'], accepters:['2','3'], rejecters:['4','5'], createdDate: new Date(2016, 6, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 2, totalElapsedTime: 20, totalDifference: +340000, childActivities: [2, 8], title: '소식지 발송 활동' },
  { id: 3, prevId: 0, state: 0, content: 'dummy content', abstainers:['1'], accepters:['2','3'], rejecters:['4','5'], createdDate: new Date(2016, 7, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 3, totalElapsedTime: 10, totalDifference: -150000, childActivities: [3], title: '한달에 한번 정보공개청구' },
  { id: 4, prevId: 0, state: 0, content: 'dummy content', abstainers:['1'], accepters:['2','3'], rejecters:['4','5'], createdDate: new Date(2016, 8, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 4, totalElapsedTime: 20, totalDifference: +352500, childActivities: [4, 5], title: 'dummy4' },
  { id: 5, prevId: 0, state: 0, content: 'dummy content', abstainers:['1'], accepters:['2','3'], rejecters:['4','5'], createdDate: new Date(2016, 9, 24, 11, 33, 30, 0), expiryDate: new Date(2018, 5, 24, 11, 33, 30, 0), parentProceeding: 5, totalElapsedTime: 20, totalDifference: -40000, childActivities: [7, 9], title: 'dummy5' }
];
var decisionID = 6;
